<?php
/**
 * 模型对象 \apiadmin\authority\models\AuthRole 的操作方法
 */
namespace apiadmin\authority\controllers;

use Yii;

class RoleController extends \webadmin\restful\AController
{
    /**
     * 定义基于控制器进行操作的模型
     */
    public $modelClass = '\apiadmin\authority\models\AuthRole';
