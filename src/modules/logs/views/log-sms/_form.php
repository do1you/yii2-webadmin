...
<div class="row log-sms-form">
		<div class="col-lg-offset-3 col-sm-offset-1 col-lg-6 col-sm-10 col-xs-12">
            <?php $form = ActiveForm::begin(); ?>
            
            <?= $form->field($model, 'mobile')->textarea(['rows' => 4]) ?>

            <?= $form->field($model, 'content')->textarea(['rows' => 6]) ?>
            
            <?= $form->field($model, 'sms_user')->textarea(['rows' => 6]) ?>

            <?= $form->field($model, 'result_code')->textInput(['value'=>$model['v_result_code']]) ?>
