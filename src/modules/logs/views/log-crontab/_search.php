...
<div class="row log-crontab-search">
	<div class="col-xs-12">
		<div class="widget margin-bottom-20">
			<div class="widget-body bordered-left bordered-themeprimary">
				...
				<?= $form->field($model, 'starttime')->searchInput()->datetimerange(['style'=>'min-width:280px;']) ?>
				
				<?= $form->field($model, 'command')->searchInput() ?>

				<?= $form->field($model, 'action')->searchInput() ?>

				<?= $form->field($model, 'args')->searchInput() ?>
