...
?>
<?php Pjax::begin(); ?>
<div class="row sys-modules-index">
                    ...
                    'columns' => [
                    	...
                    	['class' => '\yii\grid\SerialColumn'],
                	     ...
                	     [
                	         ...
                	         'template' => '{view} {update} {install}',
                	         'buttons' => [
                	             'install' => function ($url, $model) {
                	                 if($model['state']=='0'){
                	                     return Html::a('<span class="fa fa-plus"></span>', \yii\helpers\Url::toRoute(['create','id'=>$model['id']]), [
                	                         'title' => Yii::t('config', '安装'),
                	                         'data-pjax'=>'0',
                	                     ]);
                	                 }else{
                	                     return Html::a('<span class="fa fa-trash-o"></span>', \yii\helpers\Url::toRoute(['delete','id'=>$model['id']]), [
                	                         'title' => Yii::t('config', '卸载'),
                	                         'data-pjax'=>'0',
                	                     ]);
                	                 }
                	            }
