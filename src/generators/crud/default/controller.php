...
class <?= $controllerClass ?> extends <?= $generator->baseControllerClass . "\n" ?>
{
    ...
    public function beforeAction($action){
        Yii::$app->controller->pageTitle = <?= $generator->generateString(Inflector::pluralize(Inflector::camel2words(StringHelper::basename($generator->modelClass)))) ?>;
    ...
    */
    ...
    public function actionDelete()
    {
        ...
        if($id && ($models = <?= $modelClass ?>::findAll($id))){
        	$transaction = <?= $modelClass ?>::getDb()->beginTransaction(); // 使用事务关联
